...
Route::put('tratamientos', 'App\Http\Controllers\API\TratamientoController@update');
Route::delete('tratamientos', 'App\Http\Controllers\API\TratamientoController@delete');
